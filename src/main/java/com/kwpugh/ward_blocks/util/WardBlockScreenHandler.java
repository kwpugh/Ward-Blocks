...
public class WardBlockScreenHandler extends ScreenHandler {
   private final Inventory inventory;

   public WardBlockScreenHandler(int syncId, PlayerInventory playerInventory) {
      this(syncId, playerInventory, new BasicInventory(5));
   }

   public WardBlockScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
