...
{	
	...
	public static void giveExp(World world, BlockPos pos, double radius, int orbAmount)
	{
		// Scan for hostile mobs
		Box mobBox = (new Box(pos)).expand(radius, 10.0D, radius);
		List<Entity> list2 = world.getNonSpectatingEntities(Entity.class, mobBox);
	...
	public static void attackMobs(World world, BlockPos pos, double radius, float damageAmount)
	{
		// Scan for hostile mobs
		Box mobBox = (new Box(pos)).expand(radius, 10.0D, radius);
		List<Entity> list2 = world.getNonSpectatingEntities(Entity.class, mobBox);
	...
	public static void giveDefense(World world, BlockPos pos, double radius, int effectLevel)
	{
	...
	public static void giveHealth(World world, BlockPos pos, double radius, int effectLevel, float yellowHearts)
	{
		// Scan for players in range
